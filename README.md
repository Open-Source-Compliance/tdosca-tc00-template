...
* Unless otherwise specified, all other files are distributed under the terms of the [CC-BY-4.0 license](https://creativecommons.org/licenses/by/4.0/).
  - If you share or adapt (one of) the files add the attribution: "File originates from [https://github.com/Open-Source-Compliance/tdosca-tc???-???](https://github.com/Open-Source-Compliance/tdosca-tc??-???) initiated by Deutsche Telekom AG"
  - If you distribute the complete test case add the attribution: "The test case https://github.com/Open-Source-Compliance/tdosca-tc??-???](https://github.com/Open-Source-Compliance/tdosca-tc??-????) originates from the TDOSCA project initiated by Deutsche Telekom AG"
